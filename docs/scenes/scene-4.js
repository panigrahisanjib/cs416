var datasetScene4 = [
  ...
  var bubble = d3.pack(datasetScene4)
  ...
  var nodes = d3.hierarchy({ children: datasetScene4 })
  ...
  node.append("title")
    .text(function(d) {
      return d.data.year + " - " + d.data.label + ": " + d.data.population;
    });
  ...
  node.append("text")
    ...
    .text(function(d) {
      return d.data.year.toString().substring(2) + ": " + d.data.label.substring(0, d.r / 3);
    })
